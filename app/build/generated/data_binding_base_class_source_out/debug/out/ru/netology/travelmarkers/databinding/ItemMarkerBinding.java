...
public final class ItemMarkerBinding implements ViewBinding {
  ...
  private ItemMarkerBinding(@NonNull ConstraintLayout rootView, @NonNull TextView description,
  ...
  public static ItemMarkerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMarkerBinding((ConstraintLayout) rootView, description, title);
    }
